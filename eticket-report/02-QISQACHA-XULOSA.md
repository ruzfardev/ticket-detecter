...
| 5 | **Past–o'rta** | UI/UX | Kirill/lotin aralashuvi (lotin tanlansa-da "САМАРКАНД boradigan poyezdlar", bir ro'yxatda "ТАШКЕНТ Ц" va "TOSHKENT"); prod tizimda "BETA"; panelda to'liq email; past kontrast + ALL-CAPS forma; "QAYERGA"da boshlang'ich shahar filtrlanmaydi; seat-map rang-kodlash noaniq | Localization/transliteratsiya qatlami; email niqoblash; "BETA"ni olib tashlash; WCAG AA kontrast |
